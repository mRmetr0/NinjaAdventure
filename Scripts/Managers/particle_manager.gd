...
func _play_particle(sprite_sheet : Texture2D, global_pos : Vector2, sheet_length : int, particle_size : Vector2 = Vector2(1,1)):
	var new_particle = particle_obj.instantiate()
	new_particle.global_position = global_pos
	new_particle.play(sprite_sheet, sheet_length, particle_size)
